        ...
        try {
          ...
          for (const tg of generatingTasks) {
            ...
            try {
              ...
              const taskCreatedAt = Number(initialResult.created_at) || now;
      ...
      >
        ...
        {nodes.length > 0 && (
          <div className="absolute top-4 left-4 z-40 pointer-events-none select-none">
            <span className="text-3xl md:text-4xl font-black text-white tracking-widest opacity-80 hover:opacity-100 transition-opacity drop-shadow-md" style={{ fontFamily: 'Impact, sans-serif' }}>
              AI_V
            </span>
          </div>
        )}
